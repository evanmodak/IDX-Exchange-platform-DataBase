...
export default function PropertyDetailPage() {
  ...
  useEffect(() => {
    ...
    // Fetch detail and open houses in parallel. If the property lookup
    // itself fails (e.g. bad/invalid id -> 404), surface that as the
    // page-level error. If only open houses fail, don't kill the whole
    // page over it — just show none.
    Promise.all([
